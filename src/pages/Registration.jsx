  ...
  return (
    ...
    <div className="container max-w-md mx-auto space-y-8">
      ...
      <div className="flex justify-center">
        <h1 className="bg-blue-700 text-white rounded-full px-6 py-2 text-lg font-semibold">
          ChatApp
        </h1>
      </div>
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-indigo-900">Get started with easily register</h2>
      ...
      <form className="mt-8 space-y-6">
        <div className="space-y-4">
          ...
          {/* Full Name Field */}
          <div className="flex flex-col items-center">
            <label className="block text-xs text-gray-500 mb-1 text-center w-full" htmlFor="fullname">Full Name</label>
            <input
              id="fullname"
              name="fullname"
              type="text"
